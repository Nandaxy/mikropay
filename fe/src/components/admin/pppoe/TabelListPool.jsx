      ...
      <Table className="overflow-x-auto">
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="whitespace-nowrap">Nama Pool</TableHead>
          ...
          {pool.map((pools, index) => (
            <TableRow key={pools._id}>
              ...
              <TableCell className="font-medium">
                <Link to={`/router/${pools._id}`}>{pools.name}</Link>
              </TableCell>
              ...
              <TableCell>
                <div className="flex items-center space-x-4 justify-center">
                  <Button variant="outline" onClick={() => handleEdit(pools)}>
                    Edit
                  </Button>
                  ...
                  <Dialog open={isDialogOpen} onOpenChange={setDialogOpen}>
                    ...
                    <DialogContent className="flex flex-col justify-center items-center md:w-fit">
                      ...
                      <div className="flex w-full space-x-4 justify-center md:justify-end">
                        ...
                        <Button
                          variant="destructive"
                          onClick={() => handleDelete(pools._id)}
                        >
                          Hapus
                        </Button>
                      </div>
